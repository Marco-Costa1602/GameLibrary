...
namespace GameLibrary.Migrations
{
    ...
    [Migration("20210729031020_Initial2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClientGame", b =>
                {
                    ...
                    b.HasKey("ClientsId", "GameLibraryId");
            ...
            modelBuilder.Entity("GameLibrary.Models.Client", b =>
                {
            ...
            modelBuilder.Entity("ClientGame", b =>
                {
                    b.HasOne("GameLibrary.Models.Client", null)
                        .WithMany()
                        .HasForeignKey("ClientsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GameLibrary.Models.Game", null)
                        .WithMany()
