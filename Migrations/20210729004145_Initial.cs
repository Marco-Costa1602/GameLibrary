    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientGame", x => new { x.ClientsId, x.GameLibraryId });
                    table.ForeignKey(
                        name: "FK_ClientGame_AspNetUsers_ClientsId",
                        column: x => x.ClientsId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientGame_Games_GameLibraryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientGame_GameLibraryId",
                table: "ClientGame",
                column: "GameLibraryId");

            migrationBuilder.CreateIndex(
                name: "IX_Games_SaleId",
                table: "Games",
                column: "SaleId");
